...
def main():
    ...
    IMAGESDICT = {'uncovered goal': pygame.image.load('buttonBlock.png'),
                  'covered goal': pygame.image.load('selector.png'),
                  'box': pygame.image.load('boxBlock.png'),
                  'corner': pygame.image.load('Wall_Block_Tall.png'),
                  'wall': pygame.image.load('Wood_Block_Tall.png'),
                  'inside floor': pygame.image.load('floorBlock.png'),
                  'outside floor': pygame.image.load('floorBlock.png'),
                  'title': pygame.image.load('chadTitle.png'),
                  'solved': pygame.image.load('solvedButton.png'),
                  'guy': pygame.image.load('character.png'),
                  'pepe': pygame.image.load('pepehands.png'),
                  #'short tree': pygame.image.load('floorBlock.png'),
                  #'tall tree': pygame.image.load('floorBlock.png'),
                  #'ugly tree': pygame.image.load('floorBlock.png')
                  }
    ...
    OUTSIDEDECOMAPPING = {'1': IMAGESDICT['pepe'],
